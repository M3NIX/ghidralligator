...
// Allows multiple and various components to report an emulation error to the
// engine
...
// Permissions lookup table (strings -> permission bits / permissions bits ->
// strings)
inline std::map<ghidra::string, uint8_t> G_PERM_ID_MAP;
